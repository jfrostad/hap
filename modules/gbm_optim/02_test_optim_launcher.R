...
# set repo
setwd('/share/code/geospatial/kewiens/ort/gbm_optim/')
...
for (fold in cv_folds) {
  ...
  for (frac in bag_fractions) {
    ...
    mycores <- 10
    sys.sub <- paste0('qsub ',proj,paste0(' -e /share/temp/sgeoutput/kewiens/errors/',' -o /share/temp/sgeoutput/kewiens/output/ '),
