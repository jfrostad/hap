...
path.append('/snfs1/temp/jco24/miniconda2/envs/optimizer/lib/python2.7/site-packages')
# standard imports
...
y_data = data.loc[:, data.columns[col_response-1]]
...
best_pars_file = out_dir+'/best_pars_'+str(jobnum)+'.csv'
