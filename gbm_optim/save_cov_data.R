...
# add the proportion (rate) column for GBM optimizer function
the_data[, rate := get(indicator)/N]

# save the data with covariates cropped
write.csv(the_data, file = paste0('/share/scratch/tmp/jfrostad/output/gbm_optim/data/', indicator, '_', reg, 
