...
if(raked){
  ...
  filename_rds <- paste0(share_dir, "/", indicator, "_cell_draws_raked_", measure, "_eb_bin0_", reg, "_", holdout, ".rds")
...
save(admin_0,admin_1,admin_2,sp_hierarchy_list,
     file=paste0(share_dir, indicator, "_", ifelse(raked, paste0("raked_", measure), "unraked"), "_admin_draws_eb_bin", age, "_", reg, "_", holdout, ".RData"))
...
if(file.exists(paste0(share_dir, indicator, "_", ifelse(raked, paste0("raked_", measure), "unraked"), "_admin_draws_eb_bin", age, "_", reg, "_", holdout, ".RData"))){
  message("DONE!")
}else{
