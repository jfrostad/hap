...
aggregate_input_data <- function(indicator,
  ...
  # Set arguments
  code <- '/share/code/geospatial/adesh/mbg/'
  outputdir <- file.path('/share/geospatial/mbg', indicator_group, 
  ...
  for (reg in regions) {
    ...
    file_dir <- paste0('/home/j/WORK/11_geospatial/admin_shapefiles/',
                       modeling_shapefile_version, '/')
    ...
    pop_ras <- raster(
      paste0('/home/j/WORK/11_geospatial/01_covariates/00_MBG_STANDARD/worldpop/',
             'total/1y/',
